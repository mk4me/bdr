<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ExaminationForm.aspx.cs" Inherits="ExaminationForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table ID="Table1" runat="server">
        <tr>
            <td>Numer pacjenta (test):</td>
            <td>
                <asp:TextBox ID="textPatientNumber" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>Rodzaj wizyty (test):</td>
            <td>
                <asp:DropDownList ID="dropExaminationType" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
