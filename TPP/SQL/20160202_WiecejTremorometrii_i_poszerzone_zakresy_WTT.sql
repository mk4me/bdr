...
-- zmiana zakresu wartosci dla kolumn tremorometrii:
	alter table Badanie alter column UpAndGo decimal(5,2);
	alter table Badanie alter column UpAndGoLiczby decimal(5,2);
	alter table Badanie alter column UpAndGoKubekPrawa decimal(5,2);
	alter table Badanie alter column UpAndGoKubekLewa decimal(5,2);
	alter table Badanie alter column TST decimal(5,2);
	alter table Badanie alter column WTT decimal(5,2);
	

alter table Wizyta add TFZ_ReyaLubInny2 tinyint;
...
alter table Badanie add	TremorometriaLEFT_10_11 decimal(11,5);
alter table Badanie add TremorometriaLEFT_11_12 decimal(11,5);
alter table Badanie add TremorometriaLEFT_12_13 decimal(11,5);
alter table Badanie add TremorometriaLEFT_13_14 decimal(11,5);
...
alter table Badanie add	TremorometriaRIGHT_10_11 decimal(11,5);
alter table Badanie add TremorometriaRIGHT_11_12 decimal(11,5);
alter table Badanie add TremorometriaRIGHT_12_13 decimal(11,5);
alter table Badanie add TremorometriaRIGHT_13_14 decimal(11,5);
...
-- updated 2016-02-02
-- @result codes: 0 = OK, 3 = variant of this ID not found, exist 2 = validation failed - see message, 4 = user login unknown
alter procedure update_variant_examination_data_partC  (	@IdBadanie int,
	@UpAndGo	decimal(5,2),
