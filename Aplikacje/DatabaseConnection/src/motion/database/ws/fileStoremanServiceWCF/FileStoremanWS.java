 ...
 * 
 */
@WebServiceClient(name = "FileStoremanWS", targetNamespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/FileStoremanService", wsdlLocation = "http://83.230.112.43/Motion/FileStoremanWS.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://83.230.112.43/Motion/FileStoremanWS.svc?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://83.230.112.43/Motion/FileStoremanWS.svc?wsdl', retrying as a local file");
