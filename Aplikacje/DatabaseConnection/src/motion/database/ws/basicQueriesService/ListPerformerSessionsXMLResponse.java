...
import motion.database.ws.basicQueriesService.ListPerformerSessionsXMLResponse.ListPerformerSessionsXMLResult.PerformerSessionList.SessionDetails;
...
public class ListPerformerSessionsXMLResponse {
    ...
    public static class ListPerformerSessionsXMLResult {
        ...
        @XmlElementRef(name = "PerformerSessionList", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicQueriesService", type = JAXBElement.class)
        @XmlMixed
         ...
         * {@link String }
         * {@link JAXBElement }{@code <}{@link PerformerSessionList }{@code >}
         * 
         * 
         */
        ...
        public static class PerformerSessionList {
