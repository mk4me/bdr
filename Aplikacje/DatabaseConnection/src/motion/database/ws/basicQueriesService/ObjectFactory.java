...
public class ObjectFactory {
    ...
    private final static QName _SessionFileList_QNAME = new QName("http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicQueriesService", "SessionFileList");
    private final static QName _TrialFileList_QNAME = new QName("http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicQueriesService", "TrialFileList");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicQueriesService", name = "SessionFileList")
    public JAXBElement<FileListType> createSessionFileList(FileListType value) {
        return new JAXBElement<FileListType>(_SessionFileList_QNAME, FileListType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicQueriesService", name = "TrialFileList")
    public JAXBElement<FileListType> createTrialFileList(FileListType value) {
        return new JAXBElement<FileListType>(_TrialFileList_QNAME, FileListType.class, null, value);
    }
