...
/**
 * <p>Java class for UPSException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UPSException">
 *   &lt;complexContent>
...
@XmlType(name = "UPSException", propOrder = {
    "details",
    "issueKind"
})
public class UPSException {

    @XmlElementRef(name = "Details", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/UserPersonalSpaceService", type = JAXBElement.class)
    protected JAXBElement<String> details;
    @XmlElementRef(name = "IssueKind", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/UserPersonalSpaceService", type = JAXBElement.class)
