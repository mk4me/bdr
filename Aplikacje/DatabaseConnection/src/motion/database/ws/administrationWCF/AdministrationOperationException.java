...
/**
 * <p>Java class for AdministrationOperationException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AdministrationOperationException">
 *   &lt;complexContent>
...
@XmlType(name = "AdministrationOperationException", propOrder = {
    "details",
    "issueKind"
})
public class AdministrationOperationException {

    @XmlElementRef(name = "Details", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", type = JAXBElement.class)
    protected JAXBElement<String> details;
    @XmlElementRef(name = "IssueKind", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", type = JAXBElement.class)
