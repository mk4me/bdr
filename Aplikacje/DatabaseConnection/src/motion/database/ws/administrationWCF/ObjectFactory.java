 ...
 * generated in the motion.database.ws.administrationWCF package. 
...
public class ObjectFactory {
    ...
    private final static QName _AdministrationOperationException_QNAME = new QName("http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", "AdministrationOperationException");
    ...
    private final static QName _AdministrationOperationExceptionDetails_QNAME = new QName("http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", "Details");
    private final static QName _AdministrationOperationExceptionIssueKind_QNAME = new QName("http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", "IssueKind");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: motion.database.ws.administrationWCF
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AdministrationOperationException }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", name = "AdministrationOperationException")
    public JAXBElement<AdministrationOperationException> createAdministrationOperationException(AdministrationOperationException value) {
        return new JAXBElement<AdministrationOperationException>(_AdministrationOperationException_QNAME, AdministrationOperationException.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", name = "Details", scope = AdministrationOperationException.class)
    public JAXBElement<String> createAdministrationOperationExceptionDetails(String value) {
        return new JAXBElement<String>(_AdministrationOperationExceptionDetails_QNAME, String.class, AdministrationOperationException.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AdministrationService", name = "IssueKind", scope = AdministrationOperationException.class)
    public JAXBElement<String> createAdministrationOperationExceptionIssueKind(String value) {
        return new JAXBElement<String>(_AdministrationOperationExceptionIssueKind_QNAME, String.class, AdministrationOperationException.class, value);
    }
