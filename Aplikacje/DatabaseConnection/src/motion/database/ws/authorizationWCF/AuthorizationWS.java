 ...
 * 
 */
@WebServiceClient(name = "AuthorizationWS", targetNamespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AuthorizationService", wsdlLocation = "http://83.230.112.43/Motion/res/AuthorizationWSStandalone.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://83.230.112.43/Motion/res/AuthorizationWSStandalone.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://83.230.112.43/Motion/res/AuthorizationWSStandalone.wsdl', retrying as a local file");
