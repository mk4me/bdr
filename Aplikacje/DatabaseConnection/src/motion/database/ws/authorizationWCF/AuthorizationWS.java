 ...
 * 
 */
@WebServiceClient(name = "AuthorizationWS", targetNamespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AuthorizationService", wsdlLocation = "http://dbpawell.pjwstk.edu.pl/Motion/AuthorizationWS.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://dbpawell.pjwstk.edu.pl/Motion/AuthorizationWS.svc?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://dbpawell.pjwstk.edu.pl/Motion/AuthorizationWS.svc?wsdl', retrying as a local file");
