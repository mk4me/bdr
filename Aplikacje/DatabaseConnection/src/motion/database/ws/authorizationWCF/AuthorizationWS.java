 ...
 * 
 */
@WebServiceClient(name = "AuthorizationWS", targetNamespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/AuthorizationService", wsdlLocation = "http://v21.pjwstk.edu.pl/Motion/res/AuthorizationWSStandalone.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://v21.pjwstk.edu.pl/Motion/res/AuthorizationWSStandalone.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://v21.pjwstk.edu.pl/Motion/res/AuthorizationWSStandalone.wsdl', retrying as a local file");
