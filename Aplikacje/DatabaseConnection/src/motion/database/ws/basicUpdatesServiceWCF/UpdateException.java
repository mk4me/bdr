...
/**
 * <p>Java class for UpdateException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateException">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateException", propOrder = {
    "details",
    "issueKind"
})
public class UpdateException {

    @XmlElementRef(name = "Details", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicUpdatesService", type = JAXBElement.class)
    protected JAXBElement<String> details;
    @XmlElementRef(name = "IssueKind", namespace = "http://ruch.bytom.pjwstk.edu.pl/MotionDB/BasicUpdatesService", type = JAXBElement.class)
