<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountUpdate.aspx.cs" Inherits="MotionMedDBWebServices.UserAccountUpdate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Human Motion Medical Database user account update page</title>
</head>
<body>
...
<h1 style="width: 834px">Human Motion Medical Database user account update page</h1></div>   <form id="form1" runat="server">
    <div>
