...
as
	...
	begin
	  ...
	  -- jesli jakakolwiek proba posiada pliki .avi - wymagamy po max. 4 takowe dla kazdej z nich
...
/*
	-- czy dla kazdego trial-a sa max. po 4 pliki .avi
...
as
	...
	select * from @fileStoreList order by entity asc, SUBSTRING (fname, CHARINDEX ('.', fname )+1,3 ) desc;				
go
