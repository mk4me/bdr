...
public class TagWidget extends JDialog {
	...
	public TagWidget() {
		...
		new CheckBoxGroup("emg:", new String[]{"E1", "E2", "E3"}, gridBagConstraints, tagPanel);
		new CheckBoxGroup("grf:", new String[]{"G1", "G2", "G3", "G4"}, gridBagConstraints, tagPanel);
		new CheckBoxGroup("mocap:", new String[]{"M1", "M2"}, gridBagConstraints, tagPanel);
		new CheckBoxGroup("video:", new String[]{"V1", "V2"}, gridBagConstraints, tagPanel);
