...
public class CheckBoxNodeEditorOld extends AbstractCellEditor implements TreeCellEditor {
	private CheckBoxNodeRendererOld renderer = new CheckBoxNodeRendererOld();
	private ChangeEvent changeEvent = null;
	private JTree tree;
	
	public CheckBoxNodeEditorOld(JTree tree) {
		this.tree = tree;
	}
